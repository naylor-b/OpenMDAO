...
class _NonlinearBlockGSOptions(_NonIterNonlinearSolverOptions, _IterNonlinearSolverOptions):
    use_aitken: bool = Field(False, desc='set to True to use Aitken relaxation')
    ...
    aitken_initial_factor: float = Field(1.0, desc='initial value for Aitken relaxation '
                                         'factor')
